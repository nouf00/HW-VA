...
class Endpoint extends AbstractEndpoint {
    constructor({ middlewares, inputSchema, outputSchema, handler, resultHandler, description, shortDescription, mimeTypes, ...rest }) {
        ...
        [
            ...
            if ((0, common_helpers_1.hasTopLevelTransformingEffect)(schema)) {
                throw new errors_1.IOSchemaError(`Using transformations on the top level of endpoint ${name} is not allowed.`);
            }
        });
    ...
    async execute({ request, response, logger, config, }) {
        ...
        const input = (0, common_helpers_1.getInput)(request, config.inputSources);
        try {
