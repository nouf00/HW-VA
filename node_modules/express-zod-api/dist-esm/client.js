...
export class Client {
    constructor(routing) {
        ...
        const keyParamExpression = f.createTemplateExpression(f.createTemplateHead(":"), [
        ...
        const clientNode = makePublicClass("ExpressZodAPIClient", makeEmptyInitializingConstructor([
            ...
            makePublicReadonlyProp("provide", f.createTypeReferenceNode(providerNode.name), makeImplementationCallFn(["method", "path", "params"], [
                ...
                makeObjectKeysReducer("params", f.createConditionalExpression(f.createBinaryExpression(f.createCallExpression(f.createPropertyAccessExpression(f.createIdentifier("path"), "indexOf"), undefined, [keyParamExpression]), ts.SyntaxKind.GreaterThanEqualsToken, f.createNumericLiteral(0)), undefined, f.createIdentifier("acc"), undefined, f.createObjectLiteralExpression([
                    f.createSpreadAssignment(f.createIdentifier("acc")),
                    f.createPropertyAssignment("[key]", // @todo is there a better way to do it?
                    f.createElementAccessExpression(f.createIdentifier("params"), f.createIdentifier("key"))),
